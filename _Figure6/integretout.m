function [res]= integretout(longueur,largeur,b,bz)
...
global zed;
tic;
A00=sparse(largeur+1,2*longueur+1);
A01=sparse(largeur+1,2*longueur+1);
A02=sparse(largeur+1,2*longueur+1);
A10=sparse(largeur+1,2*longueur+1);
A11=sparse(largeur+1,2*longueur+1);
A12=sparse(largeur+1,2*longueur+1);
A13=sparse(largeur+1,2*longueur+1);
A14=sparse(largeur+1,2*longueur+1);
