function [res]= integretoutv2(longueur,largeur,b,bz)

'integration des matrices Aij des modes HG et LG'
...
A10=sparse(larr,2*longueur+1);
A11=sparse(larr,2*longueur+1);
A12=sparse(larr,2*longueur+1);
A13=sparse(larr,2*longueur+1);
A14=sparse(larr,2*longueur+1);
