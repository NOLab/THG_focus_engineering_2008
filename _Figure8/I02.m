...
res=exp(-n1_1200.*n1_1200.*sin(a).*sin(a)./(f0.*f0.*NA.*NA)).*sqrt(cos(a)).*sin(a).*(1-cos(a)).*besselj(2,(sin(a).*k.*p)).*exp(i*k*z*cos(a));%exp(-n1_1200.*n1_1200.*sin(a).*sin(a)./(f0.*f0.*NA.*NA)).*
